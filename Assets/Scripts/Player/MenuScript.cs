...
public class MenuScript : MonoBehaviour
{
      ...
      //  menuPanel.gameObject.SetActive(false); */
...

        {
           ...
           /* if (menuPanel.GetChild(i).name == "ForwardKey")
            ...
            if (menuPanel.transform.GetChild(i).name == "RunKey")

                menuPanel.transform.GetChild(i).GetComponentInChildren<TMP_Text>().text = GameManager.GM.jump.ToString();
        }
...

    {
        ...
        while (!keyEvent.isKey && !keyEvent.isMouse)
...

    {
...

        {
            ...
            case "run":
                ...
                GameManager.GM.run = newKey; //set run to new keycode
